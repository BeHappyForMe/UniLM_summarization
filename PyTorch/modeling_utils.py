...
from PyTorch.configuration_utils import PretrainedConfig
from PyTorch.file_utils import (
    DUMMY_INPUTS,
    TF2_WEIGHTS_NAME,
    TF_WEIGHTS_NAME,
    WEIGHTS_NAME,
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin):
    ...
    def resize_token_embeddings(self, new_num_tokens=None, keep_words=None):
        ...
        model_embeds = base_model._resize_token_embeddings(new_num_tokens,keep_words)
    ...
    def _resize_token_embeddings(self, new_num_tokens,keep_words):
        old_embeddings = self.get_input_embeddings()
        new_embeddings = self._get_resized_embeddings(old_embeddings, new_num_tokens,keep_words)
        self.set_input_embeddings(new_embeddings)
        return self.get_input_embeddings()

    def _get_resized_embeddings(self, old_embeddings, new_num_tokens=None,keep_words=None):
        ...
        new_embeddings.weight.data = old_embeddings.weight.data[keep_words]
